...
| Validacion de entradas con QR | Funcionario/Escanear | FuncionarioController | IOperativaService | OperativaRepository | Validacion, Entrada, FuncionarioEventoSector | V_ValidacionEntrada, V_PropietarioActual | trg_validacion_before_insert, trg_validacion_after_insert | Implementado con QR dinamico, carga de imagen, camara y fallback manual |
| Consulta de transferencias | Transferencias | TransferenciasController | IOperativaService | OperativaRepository | Transferencia | V_Transferencias | transferencia insert/update | Implementado |
| Consulta de validaciones por funcionario | Funcionario | FuncionarioController | IOperativaService | OperativaRepository | Validacion, FuncionarioEventoSector | V_ValidacionesPorFuncionario | - | Implementado como cobertura por sectores asignados |
