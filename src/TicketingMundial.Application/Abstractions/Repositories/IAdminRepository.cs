...
public interface IAdminRepository
{
    ...
    Task<PagedResult<EstadioAdminDto>> ListarEstadiosAsync(string paisSede, string? busqueda, string? sort, string? direction, int page, int pageSize, CancellationToken cancellationToken);
    ...
    Task<PagedResult<SectorAdminDto>> ListarSectoresAsync(string paisSede, ulong? idEstadio, string? busqueda, string? sort, string? direction, int page, int pageSize, CancellationToken cancellationToken);
    ...
    Task<PagedResult<EventoAdminDto>> ListarEventosAsync(string paisSede, string? busqueda, string? estado, string? sort, string? direction, int page, int pageSize, CancellationToken cancellationToken);
    ...
    Task<EventoCambioEstadoResultadoDto?> CambiarEstadoEventoAsync(ulong idEvento, string estado, string paisSede, CancellationToken cancellationToken);
}
